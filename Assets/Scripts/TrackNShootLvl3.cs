...
public class TrackNShootLvl3 : MonoBehaviour
{
    [Header("Transforms")]
    ...
    private void Shoot3()
    {
        GameObject laserNew3 = (GameObject)Instantiate(laser, firePoint3.position, firePoint3.rotation);
        LaserShooter shooter3 = laserNew3.GetComponent<LaserShooter>();

        shooter3.Seek(target);
